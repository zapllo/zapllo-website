            ...
            <div className=' mt-4 '>
                ...
                <div className='grid grid-cols-2  w-full max-w-7xl items-center'>
                    ...
                    <div>
                        ...
                        <h1 className='text-2xl mt-4'>Check Progress using MIS Score</h1>
                        <p className='text-muted-foreground w-full max-w-lg mt-4 text-sm'>Track task progress within the app, with instant notifications on completion.</p>
