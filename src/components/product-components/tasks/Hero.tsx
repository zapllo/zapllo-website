    ...
    return (
        <div className='bg-[#05071E] '>
            ...
            <div className='flex justify-center'>
                <h1 className='text-center text-3xl  bg-clip-text    md:text-5xl  mt-4   mx-4 max-w-5xl'><span className='bg-gradient-to-r from-[#815BF5] bg-clip-text text-transparent font-semibold   to-[#FC8929]'>Task Delegation App <br />
                </span>

                </h1>
            </div>
            <div className='flex justify-center'>
                <span className='mt-4 text-center md:text-4xl'>  Manage your Team in just 10 mins a day </span>
            </div>
            <div className='flex justify-center '>
