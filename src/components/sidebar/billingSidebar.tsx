            ...
            <div className='space-y-4'>
                <div className='flex justify-center'>
                    <Button
                        ...
                        className={`w-[90%] rounded-none mt-6 gap-2 px-4 justify-start hover:bg-transparent bg-transparent mb-2 ${isActive('/dashboard/billing') ? 'bg-[#75517B] hover:bg-[#75517B] rounded-lg text-white' : 'text-gray-400'}`}
                ...
                <div className='flex justify-center'>
                    <Button
                        ...
                        className={`w-[90%] rounded-none gap-2 px-4 bg-transparent justify-start hover:bg-transparent mb-2 ${isActive('/dashboard/billing/wallet-logs') ? 'bg-[#75517B] hover:bg-[#75517B] rounded-lg text-white' : 'text-gray-400'}`}
