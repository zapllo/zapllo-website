      ...
      <SheetContent className="max-w-4xl w-full">
        <SheetHeader>
          <div className="flex gap-2">
            <ArrowLeft
              className="cursor-pointer h-7 w-7 bg-[#121212] border border-white rounded-full"
              onClick={onClose}
            />
        ...
        <div className="border overflow-y-scroll scrollbar-hide h-10/11 p-4 rounded-lg">
          ...
          <div className="flex gap-28 ml-1">
            <div className="flex items-center gap-1 mt-4 ml-[-6px]">
              <Calendar className="h-4 text-[#E94C4C]" />
              <Label htmlFor="fromDate" className="text-right text-sm">
                From Date
              </Label>
              <div className="flex gap-2 ml-6 text-xs justify-start">
          ...
          {selectedLeave.attachment && selectedLeave.attachment.length > 0 && (
            <div className="mt-6">
              <Label htmlFor="attachments" className="text-right text-sm">
                Attachments
              </Label>
                    ...
                    <div className="flex gap-2 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          {new Date(selectedLeave.updatedAt).toLocaleString()}
                        </p>
