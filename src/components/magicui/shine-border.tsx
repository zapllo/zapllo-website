...
export default function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid min-h-[10px] -mt-2  w-fit min-w-[100px] scale-75 place-items-center rounded-[--border-radius]  bg-white px-6 py-3 text-black dark:bg-black dark:text-white",
        className,
      )}
    >
      <div
