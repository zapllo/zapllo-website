...
import { Paperclip, Mic, Calendar, X } from "lucide-react";
          ...
          <div className="bg-[#1A1C20] overflow-y-scroll scrollbar-hide h-fit max-h-[600px]  shadow-lg w-full   max-w-md p-6 rounded-lg">
            <div className="flex justify-between mb-4">
              ...
              <Dialog.DialogClose className="-mt-4">
                {/* <img src='/icons/cross.png' className='h-5 hover:bg-[#121212] rounded-full' /> */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4 ">
              ...
              <canvas
                ref={canvasRef}
                className={` ${recording ? `w-1/2 h-fit` : "hidden"} `}
              ></canvas>
              {audioBlob && (
                <CustomAudioPlayer
                  audioBlob={audioBlob}
