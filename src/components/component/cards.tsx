...
* @see https://v0.dev/t/P7iPgbekdfh
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
        <div className="bg-card rounded-lg shadow-lg transform transition-all duration-300 hover:scale-110">
          <div className="p-6">
            ...
            <p className="text-muted-foreground">Accelerate your business with our innovative solutions.</p>
          </div>
        </div>
        <div className="bg-card rounded-lg shadow-lg transform transition-all duration-300 hover:scale-110">
          <div className="p-6">
            ...
            <p className="text-muted-foreground">Streamline your operations for maximum productivity.</p>
          </div>
        </div>
        <div className="bg-card rounded-lg shadow-lg transform transition-all duration-300 hover:scale-110">
          <div className="p-6">
            ...
            <p className="text-muted-foreground">Tailor our solutions to fit your unique business needs.</p>
          </div>
        </div>
        <div className="bg-card rounded-lg shadow-lg transform transition-all duration-300 hover:scale-110">
          <div className="p-6">
