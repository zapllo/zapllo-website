        ...
        <div className='bg-[#05071E] '>
            <div className="z-10 flex items-center justify-center">
                <AnimatedGradientText>
                    ...
                    <span
                        className={cn(
                            `inline animate-gradient text-sm md:text-lg font-bold bg-gradient-to-r from-[#815BF5] via-[#FC8929] to-[#FC8929] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent`,
                        )}
                    >
