              ...
              {["Daily", "Weekly", "Monthly", "Once"]
                ...
                .map((frequency) => (
                  ...
                  >
                    <div className="flex">
                      <img
                        src={`/icons/${frequency.toLowerCase()}.png`}
                        alt={frequency}
                        className="mr-2 h-6"
                      />
                      {frequency}
              ...
              {["High", "Medium", "Low"]
                ...
                .map((priority) => (
                  ...
                  >
                    <div className="flex">
                      <img
                        src={`/icons/${priority.toLowerCase()}.png`}
                        alt={priority}
                        className="mr-2 h-6"
                      />
                      {priority}
        ...
        <div className="inline-block align-bottom  z-[60] h-[450px] bg-[#0B0D29]  rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:align-middle sm:max-w-xl sm:w-full ">
          ...
          <div>
            <div className="flex">
              <div className=" border-r h-[400px]  ">
                <ul className="space-y-2 mt-2  ">
                  {sections.map((section) => (
                    <li
                      key={section.name}
                      className={`cursor-pointer text-sm px-12 p-3 w-full flex items-center ${
                        activeSection === section.name ? "bg-[#282D32] " : ""
                      }`}
                      onClick={() => {
              ...
              <div
                className="w-[60%] p-6  overflow-y-auto scrollbar-hide"
