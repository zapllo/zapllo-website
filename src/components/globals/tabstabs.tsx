...
export default function TeamTabs() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="flex  gap-2 -ml-32 justify-between mb-6 w-full">
        <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full justify-start ">
        ...
        <div className="grid text-sm w-full  gap-4">
          {filteredUsers
            .filter((user) => {
            ...
            .map((user) => (
              <div key={user._id}>
                <Card key={user.firstName} onClick={() => setSelectedUser(user)} className="flex cursor-pointer items-center justify-between w-full p-2">
