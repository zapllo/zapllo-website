    ...
    return (
        <Dialog.Root open={isOpen} onOpenChange={onClose}>
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed inset-1/2 w-[90vw] max-w-md transform -translate-x-1/2 -translate-y-1/2 bg-[#1A1C20] z-[100]  max-h-3xl h-fit text-[#D0D3D3]  rounded-lg p-8">
