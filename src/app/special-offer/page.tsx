...
export default function Home() {
    ...
    const [showCheckout, setShowCheckout] = useState(false); // State to manage checkout form display
    ...
    return (
        ...
        <main className="bg-[#] bg-[#05071E] w-full  mx-auto h-full z-10 overflow-hidden">
            ...
            <div className="w-full py-2 bg-gradient-to-r from-[#815BF5] via-[#9D5DF0] to-[#FC8929] flex items-center justify-center mt-32 ">
                ...
                <div className="bg-white text-[#05071E] font-semibold px-4 py-1 rounded-md">
                    {formatTime(timeLeft)}
                </div>
            </div>
            ...
            <div className="  bg-[#05071E]">
                ...
                <div className="flex justify-center">
                    <h1 className="text-center text-2xl  bg-clip-text  font-extrabold  md:text-4xl mt-4   mx-4 md:max-w-[1000px]">
                ...
                {showCheckout ? (
                    ...
                    <div className="grid grid-cols-3 w-full max-w-7xl   justify-center gap-12 relative">
                        ...
                        <div className="bg-[#0A0D28] mt-8 border rounded-[50px_50px_50px_50px] w-full   p-6 text-white relative z-10 shadow-lg">
                            <div className="absolute -top-0 right-1 bg-gradient-to-r from-[#815BF5] to-[#FC8929] px-4 py-1 rounded-[0_50px_0_20px] text-sm font-bold text-white">
                                Get Flat 50% OFF
                            </div>
                            ...
                            <button  onClick={() => setShowCheckout(true)} className="mt-6 w-full py-2 border-2 border-primary rounded-full font-semibold   transition-colors">
