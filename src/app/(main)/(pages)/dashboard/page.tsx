        ...
        <div className=" w-full h-48 flex justify-start gap-4">
          <div className="p-4  w-full mx-4 rounded  border border-[#E0E0E066]">
            <div className="w-full p">
              ...
              <h1 className="px-4 py-4 text-sm">
                Learn how to to get best out of our business workspace{" "}
              </h1>
              <Link href="/help/tutorials">
                <Button className="bg-white text-black ml-4  hover:bg-white mt-6">
                  Go To Tutorials
                </Button>
              </Link>
              <img
                src="/animations/tutorials.png"
                className="absolute h-48 ml-[45%] -mt-[150px]"
              />
            </div>
          </div>
        </div>
            ...
            <div className="p-4  w-full mx-4 rounded  border border-[#E0E0E066]">
              <div className="w-full m">
                ...
                <p className="text-sm py-4">
                  We are bringing Live Classes to help you grow your business.
                  Check out all our events to get the best out of our business
                  workspace.{" "}
                </p>
              </div>
          ...
          <div className="p-4 w-full border border-[#E0E0E066] bg-[#221126]  m-4  text-white items-center flex justify-start rounded ">
            <div className=" font-bold text-xl space-y-1">
              <div className="rounded-full h-12 border-[#E0E0E066] border w-12">
                <img
                  src="/icons/atask.png"
                  className=" ml-[15px] mt-3 h-6     object-cover"
                />
              </div>
            ...
            <div className=" font-bold text-xl space-y-1">
              <div className="rounded-full h-12 border-[#E0E0E066] border w-12">
                <img
                  ...
                  className=" ml-3 mt-3 h-6     object-cover"
                />
              </div>
            ...
            <div className=" font-bold text-xl space-y-1">
              <div className="rounded-full h-12 border-[#E0E0E066] border w-12">
                <img
                  ...
                  className=" ml-3 mt-[10px] h-6     object-cover"
                />
              </div>
          ...
          <div className="p-4 w-full border border-[#E0E0E066] bg-[#221126]  m-4  text-white items-center flex justify-start rounded ">
            <div className=" font-bold text-xl space-y-1">
              <div className="rounded-full h-12 border-[#E0E0E066] border w-12">
                <img
                  src="/icons/crm.png"
                  className=" ml-[10px] mt-3 h-6  invert-[100]    object-cover"
                />
              </div>
              ...
              <div className="pt-2">
                <Link href="/dashboard/tasks">
                  <Button className="bg-[#7C3886] py-1 hover:bg-[#7C3886] opacity-50 text-xs">
                    Coming Soon
                  </Button>
                </Link>
              </div>
