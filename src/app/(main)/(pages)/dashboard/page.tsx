...
const DashboardPage = () => {
  return (
    <div className=' dark:bg-[#211025] pt-4 gap-4 relative overflow-x-hidden scrollbar-hide'>
      ...
      <div className='p-4 m-4 ml-10 border border-[#616072] bg-[#221126] w-full max-w-5xl   text-white items-center flex justify-start rounded-2xl '>
        <div className=' font-bold text-xl space-y-2'>
          ...
          <Progress value={100} className='w-[%]' />

          <Button className='bg-[#7C3886] ml-auto hover:bg-[#7C3886]' >Checklist</Button>
